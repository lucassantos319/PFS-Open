...
public class ImportanceApplication(string connectionString) : IApplication<Importance>
{
    private readonly ImportanceRepository _repository = new(connectionString);
    ...
    public void Update(Importance obj)
    {
